...
ggplot(data, aes(datetime2, temp)) + geom_line(aes(color = site)) +
  ggtitle("") + ylab("Temperature (C˚)")+xlab("") + theme_bw() + scale_x_datetime(breaks = "1 day", date_labels = ("%b %d")) +  theme(axis.text.x =element_text(angle = 45, hjust = 1)) + geom_vline(xintercept = -61548450000, color = "red", linetype = 4, size = 1.1) + geom_vline(xintercept = -61547930000, color = "yellowgreen", linetype = 4, size = 1.1) + geom_vline(xintercept = -61547590000, color = "turquoise3", linetype = 4, size = 1.1) + geom_vline(xintercept = -61547420000, color = "purple", linetype = 4, size = 1.1) 

ggsave("fieldHOBOtemps.png", width = 6, height = 4)
